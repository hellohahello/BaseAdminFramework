...
<head>
    <meta charset="utf-8">
    <title>/(ㄒoㄒ)/~~ - 找不到了</title>
    <style>
        *{padding:0;margin:0}
        a{text-decoration:none}
        .notfoud-container .img-404{height:155px;background:url(/assets/images/error/404-pc.png) center center no-repeat;-webkit-background-size:150px auto;margin-top:40px;margin-bottom:20px}
